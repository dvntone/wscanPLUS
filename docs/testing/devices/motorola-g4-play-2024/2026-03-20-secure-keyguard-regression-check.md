...
- Revvl Tab 2 / Android 15 was not re-tested after the current permission/service fixes; keep its open findings as unresolved until a post-fix Revvl validation run happens
