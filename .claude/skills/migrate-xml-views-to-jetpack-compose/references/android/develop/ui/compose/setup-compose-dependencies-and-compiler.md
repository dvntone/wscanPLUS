...
Always use the latest stable Compose BOM (e.g. `2026.03.00` — check the [official BOM mapping](https://developer.android.com/jetpack/compose/bom/bom-mapping) for the most current version).
